...
<div class="w w1 header clearfix">
	<div id="logo"><a href="/"><img clstag="clickcart|keycount|xincart|logo" src="/images/ego-logo.gif" title="返回财大商城首页" alt="返回财大商城首页"></a></div>
...
<div class="cart-inner">
    <div class="cart-thead clearfix">
        ...
        <div class="column t-price">财大价</div>
        ...
        <c:forEach items="${cartList}" var="cart">
	        ...
	        <div id="product_11345721" data-bind="rowid:1" class="item item_selected ">
		        <div class="item_form clearfix">
		            ...
		            <div class="cell p-remove"><a id="remove-11345721-1" data-more="removed-87.20-1" clstag="clickcart|keycount|xincart|btndel318558" class="cart-remove mycart_remove" href="/cart/delete/${cart.id}">删除</a>
		            </div>
		        </div>
	        </div> 
        </c:forEach>
              ...
              <div class="cart-button">
                  ...
                  <span class="combine-btns" style="display:none">
                      ...
                      <span class="fore2 hide" style="display: inline;">
                          <a href="javascript:goToOverseaOrder();" class="checkout-jdInt">去财大国际结算<b></b></a>
                          <a href="javascript:goToOrder();" class="checkout-jd">去财大结算<b></b></a>
                      </span>
                  </span>
              </div>
              <div class="total fr">
