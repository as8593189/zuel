...
<div class="w" id="logo">
    <div>
        <a href="http://localhost:8082">
            <img src="/images/ego-logo.gif" alt="财大商城" width="170" height="60"/>
        </a> <b></b>
    </div>
</div>
    ...
    <div class="mc">
        <form id="personRegForm" method="post" onsubmit="return false;">
            <div class="form" onselectstart="return false;">
                ...
                <div class="item" id="select-email">
                    <span class="label"><b class="ftx04">*</b>邮箱：</span>

                    <div class="fl item-ifo">
                        <div class="o-intelligent-regName">
                            <input type="text" id="email" name="email" class="text" tabindex="1" autoComplete="off"
                                   onpaste="return false;"
                                   value=""
                                   onfocus="if(this.value=='') this.value='';this.style.color='#333'"
                                   onblur="if(this.value=='') {this.value='';this.style.color='#999999'}"/>
                            <i class="i-name"></i>
                            <ul id="intelligent-email" class="hide"></ul>
                            <label id="email_succeed" class="blank"></label>
                            <label id="email_error" class="hide"></label>
                        </div>
                    </div>
                </div>
                <div id="o-password">
                ...
                <div class="item item-new">
                    ...
                    <div class="fl item-ifo">
                        ...
                        <label for="protocol">我已阅读并同意<a href="#" class="blue" id="protocol">《财大用户注册协议》</a></label>
                        <span class="clr"></span>
